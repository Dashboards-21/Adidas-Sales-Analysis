...
Project Objective:
The objective of this project is to analyze Adidas U.S. sales data to identify key sales trends, product performance, and regional insights. By using Power BI and Excel for data cleaning, transformation, and visualization, the goal is to uncover meaningful patterns that support business decisions, improve sales strategy, and enhance overall profitability. 
